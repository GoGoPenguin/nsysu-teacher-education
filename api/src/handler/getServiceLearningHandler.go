...
// GetServiceLearningHandler get service-learning list
func GetServiceLearningHandler(ctx iris.Context) {
	type rule struct {
	...
	result, err := service.GetServiceLearningList(account, params.Start, params.Length, params.Search)
