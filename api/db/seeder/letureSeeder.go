...
func letureSeeder() {
	...
	categoryData := []map[string]interface{}{
		...
		map[string]interface{}{"ID": uint(11), "LetureID": uint(7), "Name": "領域核心課程", "MinCredit": uint(4), "MinType": uint(4)},
		map[string]interface{}{"ID": uint(12), "LetureID": uint(7), "Name": "領域內跨科課程", "MinCredit": uint(12), "MinType": uint(3)},
		map[string]interface{}{"ID": uint(13), "LetureID": uint(7), "Name": "公民與社會專長課程", "MinCredit": uint(34), "MinType": uint(34)},
	}
